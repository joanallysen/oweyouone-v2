...
export default async function ProfilePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col pb-24 bg-bg text-text">
      <div className="sticky top-0 z-10 bg-bg/95 backdrop-blur-sm px-5 py-4 border-b border-border">
      ...
      <div className="px-5">
        <h2 className="text-sm text-sec mb-2">Balances</h2>
        <div className="grid grid-cols-3 gap-2">
          <div className="bg-surface border border-border rounded-lg p-3">
            <p className="text-xs text-sec mb-1">I owe</p>
            <p className="text-owe font-semibold">${iOwe.toFixed(2)}</p>
          </div>
          <div className="bg-surface border border-border rounded-lg p-3">
            <p className="text-xs text-sec mb-1">They owe</p>
            <p className="text-owed font-semibold">${theyOwe.toFixed(2)}</p>
          </div>
          <div className="bg-surface border border-border rounded-lg p-3">
            <p className="text-xs text-sec mb-1">Net</p>
            <p className={`font-semibold ${net >= 0 ? 'text-owed' : 'text-owe'}`}>
      ...
      <div className="px-5 mt-8">
        <h2 className="text-sm text-sec mb-2">Account</h2>
        <Link
          href="/profile/edit"
